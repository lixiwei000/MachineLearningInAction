...
# print(classify0([1,1],group,labels,5))

# 将文本转换成矩阵
# datingDataMat,datingLabels = file2matrix('/Users/lixiwei-mac/Documents/IdeaProjects/MachineLearningInAction/dataSet/datingTestSet2.txt')
#print(datingDataMat,"\n",datingLabels)
...
def handwritingClassTest():
    hwLabels = []
    trainingFileList = listdir('/Users/lixiwei-mac/Documents/IdeaProjects/MachineLearningInAction/dataSet/digits/trainingDigits')
    ...
    for i in range(m):                                  # 将训练集转换为符合格式的向量
        ...
        trainingMat[i,:] = img2vector('/Users/lixiwei-mac/Documents/IdeaProjects/MachineLearningInAction/dataSet/digits/trainingDigits/%s' % fileNameStr)
    testFileList = listdir('/Users/lixiwei-mac/Documents/IdeaProjects/MachineLearningInAction/dataSet/digits/testDigits')
    ...
    for k in range(3,10):
        ...
        for i in range(mTest):
            ...
            fileStr = fileNameStr.split('.')[0]
            classNumStr = int(fileStr.split('_')[0])
            vectorUnderTest = img2vector('/Users/lixiwei-mac/Documents/IdeaProjects/MachineLearningInAction/dataSet/digits/testDigits/%s' % fileNameStr)
